...
public class GameView extends JPanel {
	private static final Color WEIRD_PURPLE = new Color(125, 66, 244);
	private static final Color WEIRD_GREEN = new Color(163, 244, 65);
